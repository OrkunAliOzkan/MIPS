...
then
    ...
    testcases="./test/testcasesnew/${instruction^^}_${temp}_test.txt" #IF YOU HAVE MULTIPLE TEST CASES, YOU MAY NEED TO ADD AN ASTERISK, LIKE _*
else
